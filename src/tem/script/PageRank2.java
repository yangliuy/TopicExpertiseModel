...
//scoure: http://blog.csdn.net/chen_jp/article/details/7905235
...
public class PageRank2 {
	...
	public static void main(String[] args) {
		...
		q1.add(new Double(0));
		q1.add(new Double(0));
		System.out.println("初始的状态向量q为:");
		printVec(q1);
		System.out.println("初始的转移矩阵G为:");
